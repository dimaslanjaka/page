	...
	initialize: function (picker, data, methods) {
		...
		if (data.showRightIcon) {
			if (data.uiLibrary === 'bootstrap') {
				...
				rightIcon.innerHTML =
					'<button class="btn btn-outline-secondary border-left-0" type="button">' + data.icons.rightIcon + '</button>';
			} else {
...
gj.core.messages['id-id'] = {
	...
	monthShortNames: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'June', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', ' Des'],
